...
function onResultsFaceMesh(results) {
  ...
  // // flip
  // canvasCtx.scale(-1, 1);
  // canvasCtx.translate(-out2.width, 0);
  ...
  if (results.multiFaceLandmarks) {
    for (const landmarks of results.multiFaceLandmarks) {
      ...
      drawConnectors(
          ...
          {color: '#E0E0E0'});
      // console.log(FACEMESH_RIGHT_EYE) // eye connect relation
      //console.log(landmarks)
    }
  }
  console.log(results.FaceGeometryFromLandmarks)
  //canvasCtx.setTransform(1, 0, 0, 1, 0, 0);

  // Kalidokit.Face.solve(results.multiFaceLandmarks ,{
  //   runtime:'mediapipe', // default is 'tfjs'
  //   video: video2,// specify an html video or manually set image size
  //   imageSize:{
  //       width: 640,
  //       height: 480,
  //   },
